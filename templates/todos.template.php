...
<head>
    ...
    <title>Taskeo - <?php echo $data['title']; ?></title>
...
<div class="container">
    ...
    <main>
        <h1 class="title">Welcome to Fosa Framework !</h1>
        <p class="description">Fosa framework is free and open PHP based web framework build for endemic developer. You use the beta 0.1 version of the framework. Official 1.0 version will be released soon. Enjoy and contribute too !</p>
        <div class="cards">
            <div class="card">
            ...
            <div class="card">
                ...
                <span>Build static website</span>
            </div>
        </div>
    </main>
    <footer>
        <a href="#" target="_blank" rel="noreferrer"><i class="fab fa-github"></i>Follow Fosa on Github</a>
        <a href="#"><i class="fas fa-flag"></i>Malagasy</a>
    </footer>
</div>
</body>
</html>