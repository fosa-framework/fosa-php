...
$translation = [
    'app' => [
        ...
        'main' => [
            ...
            'content' => 'Le framework Fosa est un framework Web gratuit et ouvert basé sur PHP pour les développeurs endémiques. Vous utilisez la version bêta 0.1 du framework. La version officielle 1.0 sera bientôt disponible. Profitez et contribuez !',
        ],
        'features' => [
            'web-app' => 'Créer une application Web',
            'rest-api' => 'Construire un API REST',
