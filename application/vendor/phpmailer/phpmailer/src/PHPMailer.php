...
class PHPMailer
{
     ...
     *
     * @param string $langcode  ISO 639-1 2-character language code (e.g. French is "fr-FR")
     * @param string $lang_path Path to the language file directory, with trailing separator (slash)
     *
     * @return bool
     */
    public function setLanguage($langcode = 'en-EN', $lang_path = '')
    {
     ...
     * Note - older versions of this function used a dist advanced converter
